...
/// <summary>GDI+ 绘制的发光状态指示灯（T-081 从 MainWindow 嵌套类提升为顶层类）。替换 Region 裁剪方案，绘制带发光效果和镜面高光的圆形。</summary>
internal class GlowDot : Panel
{
    public GlowDot()
    {
        Size = new Size(16, 16);
...
/// <summary>带百分比文字的进度条（T-081 从 MainWindow 嵌套类提升为顶层类）——自绘控件，在进度条上方叠加居中百分比文字。</summary>
internal class ProgressBarWithText : Control
{
